    ...
    \section{Earth-Sun system}
        \subsection{Comparison between the two algorithms}
            \paragraph{}Let's compare the results between using the Euler's method and the Verlet's method.
                ...
                \begin{center}
                    Euler's method over 1, 2 and 50 years (from left to right)
                \end{center}
                ...
                \begin{center}
                    Verlet's method over 1, 2 and 50 years (from the left to the right)
                \end{center}
        ...
        \subsection{Escape velocity}
            \paragraph{}We have computed the theorical escape velocity in 1.1.2.
                ...
                \end{figure}
            Experimentally, the escape value is 8.8756 AU/yr which is closed to the theorical value $2\sqrt{2}\pi \approx 8.8858$ AU/yr.
    ...
    \section{Three-body problem}
        \subsection{The Sun as the center-of-mass}
            Here, we have kept the Sun as the center-of-mass. We have tested two things : the influence of Jupiter on the Earth, and its influence on the Earth when we change the mass of Jupiter. 
                ...
                \begin{center} 
                    The evolution of the position of the Earth, Jupiter and the Sun over 20 and 100 years (from left to right)
                \end{center}
                ...
                \begin{center}
                    The influence of Jupiter on the Earth for $M_{\jupiter}=10\times M_{\jupiter}, M_{\jupiter}= 100\times M_{\jupiter} and M_{\jupiter} = M_{\odot}$ (from the left to ther right)
                \end{center}
        ...
        \subsection{The real center-of-mass}
            \paragraph{}Here, we change the center-of-mass from the Sun to the real one. The coordinates of the three bodies with respect to the new origin have been computed in 1.2.2.
                ...
                \end{figure}
                \begin{center}
                    The position of the three bodies over 20 and 100 years (from the left to the right)
                \end{center}
            The orbits of the Earth and Jupiter are quite the same as the case where the center-of-mass was set to the Sun. The orbit of the Sun is however different (the Sun is not fixed anymore).
                ...
                \end{figure}
                \begin{center}
                    The orbit of the Sun around the center-of-mass over 20 and 100 years (from the left to the right)
                \end{center}
