    ...
    \section{Earth-Sun system}
        \subsection{Comparison between the two algorithms}
            \paragraph{}Let's compare the results between using the Euler's method and the Verlet's method.
                ...
                \begin{center}
                    Figure 1 : Euler's method over 1, 2 and 50 years (from left to right)
                \end{center}
                ...
                \begin{center}
                    Figure 2 : Verlet's method over 1, 2 and 50 years (from the left to the right)
                \end{center}
        ...
        \subsection{Escape velocity}
            \paragraph{}We have computed the theorical escape velocity in 1.1.2.
                ...
                \end{figure}\\
                \begin{center}
                    Figure 3 : The Earth orbit around the Sun for $v_i=3.287$ AU/yr, $v_i=8.0355$ AU/yr, $v_i=8.77$ AU/yr and $v_i=8.8756$ AU/yr (from the left to the right, top to bottom)
                \end{center}

            Experimentally, the escape value is $v_{e_e}=8.8756$ AU/yr which is really close to the theorical value $v_{e_t}=2\sqrt{2}\pi \approx 8.8858$ AU/yr.
    ...
    \section{Three-body problem}
        \subsection{The Sun as the center-of-mass}
            Here, we have kept the Sun as the center-of-mass. We have tested two things : the influence of Jupiter on the Earth, and its influence on the Earth when we change the mass of Jupiter. 
                ...
                \begin{center} 
                    Figure 4 : The evolution of the position of the Earth, Jupiter and the Sun over 20 and 100 years (from left to right)
                \end{center}
                ...
                \begin{center}
                    Figure 5 : The influence of Jupiter on the Earth for $M_{\jupiter}=10\times M_{\jupiter}, M_{\jupiter}= 100\times M_{\jupiter}$ and $M_{\jupiter} = M_{\odot}$ (from the left to the right)
                \end{center}
            ...
            \paragraph{}Here, we change the center-of-mass from the Sun to the real one. The coordinates of the three bodies with respect to the new origin have been computed in 1.2.2.
                \begin{figure}[h!]
                    \hbox{
                        \begin{minipage}[c]{.46\linewidth}
                            \centering
                            \includegraphics[width=7cm,height=7cm]{EJS_r20y.png}
                        \end{minipage}
                        \hfill
                        \begin{minipage}[c]{.46\linewidth}
                            \centering
                            \includegraphics[width=7cm,height=7cm]{EJS_r100y.png}
                        \end{minipage}
                    }
                \end{figure}
                \begin{center}
                    Figure 6 : The position of the three bodies over 20 and 100 years (from the left to the right)
                \end{center}
            The orbits of the Earth and Jupiter are quite the same as the case where the center-of-mass was set to the Sun. The orbit of the Sun is however different (the Sun is not fixed anymore).
                \begin{figure}[h!]
                    \hbox{
                        \begin{minipage}[c]{.46\linewidth}
                            \centering
                ...
                \end{figure}
                \begin{center}
                    Figure 7 : The orbit of the Sun around the center-of-mass over 20 and 100 years (from the left to the right)
                \end{center}
...
\addcontentsline{toc}{chapter}{Conclusion}
    ...
    \paragraph{}
        \begin{tabular}{|c|c|c|}
            \cline{2-3}
            \multicolumn{1}{c|}{\multirow{2}*{}} & \multicolumn{2}{c|}{Execution time}\\
            \cline{2-3}
            \multicolumn{1}{c|}{} & Euler & Verlet \\
            \hline
            \multirow{3}*{tamère} & $$ & $$ \\
            \cline{2-3}
            & $$ & $$ \\
